...
O sensor de presença é uma entrada que gera um sinal digital e por esse mesmo motivo os terminais _Trig_ e _Echo_ do sensor devem ser conectados cada um a um pino digital do ESP. Os outros terminais devem ser conectados no VCC e no GND.
